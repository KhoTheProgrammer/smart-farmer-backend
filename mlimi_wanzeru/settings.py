"""
Django settings for mlimi_wanzeru project.
"""
...
ROOT_URLCONF = 'mlimi_wanzeru.urls'
...
WSGI_APPLICATION = 'mlimi_wanzeru.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='mlimi_wanzeru'),
